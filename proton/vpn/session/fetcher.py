...
class VPNSessionFetcher:
    ...
    async def fetch_location_names(self) -> LocationTranslations:
        """Fetches localized city/state names for the session locale."""
        return await self._location_names_fetcher.fetch()
    ...
    def load_location_names_from_cache(self) -> LocationTranslations:
        """Loads the cached city/state name translations for the session locale."""
